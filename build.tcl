...
set files [list \
 ...
 [file normalize "$origin_dir/src/core_rtl/ac.v" ]\
 ...
 [file normalize "$origin_dir/src/mig/floating_point_0.xci" ]\
 [file normalize "$origin_dir/src/mig/floating_point_1.xci" ]\
]
...
# Adding floating point evaluate IP
# Set 'sources_1' fileset file properties for local files
...
# Addding floating point compare IP
# Set 'sources_1' fileset file properties for local files
